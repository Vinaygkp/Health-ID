...
// Safe import for site configuration if it exists
...
/**
 * Reload when a module that previously defined a React Refresh boundary stops defining one.
 */
...
/**
 * Serves a blank render-target page at /.figma/make/kit.html for dev mode.
 */
